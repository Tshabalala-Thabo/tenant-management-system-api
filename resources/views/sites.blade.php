                    ...
                    <a href="{{ route('sites.view', ['id' => $site->id]) }}">
                        <div class="flex justify-between bg-white p-4 shadow-md rounded-lg">
                            <div class="flex items-center mb-2">
                                <ion-icon name="business" class="size-16 text-primary-600 mr-3"></ion-icon>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-lg font-bold">{{ ucfirst($site->name) }}</span>
                                <span class="text-gray-600">{{ $site->address_line1 }}
                                    @if($site->address_line2)
                                    <br>{{ $site->address_line2 }}
                                    @endif
                                    <br>
                                    {{ $site->city }}{{ $site->postal_code ? ', ' . $site->postal_code : '' }}</span>
                            </div>
                        </div>
                    </a>
                </div>
