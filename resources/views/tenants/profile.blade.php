    ...
    openLeaseModal: false}" class="flex flex-wrap gap-y-4 px-3 pb-5">
        ...
        <div class="w-9/12 pl-3">
            ...
            <div class="grid grid-cols-3 w-full gap-2">
                @if($tenant->tenantTickets && $tenant->tenantTickets->isNotEmpty())
                    @foreach($tenant->tenantTickets as $ticket)
                        <div class="bg-gray-300 shadow-md px-4 h-min py-2 rounded-lg">
            ...
            <div class="w-full mt-7 flex justify-between items-end p-1">
                ...
                <button
                    class="bg-primary-600 shadow-md text-black px-4 py-2 rounded-md hover:bg-primary-700">
                    Create invoice
                </button>
            ...
            <table class="table-auto w-full mt-1 rounded-lg shadow-md overflow-hidden">
                ...
                <tr class="border-t border-gray-300 cursor-pointer">
                    ...
                    <td class="px-4 py-2 flex items-center">
                        <ion-icon name="eye" class="mr-1 size-6 text-gray-500"></ion-icon>
                        <ion-icon name="pencil" class="mr-1 size-6 text-gray-500"></ion-icon>
                        <ion-icon name="trash" class="size-6 text-danger"></ion-icon>
                    </td>
                </tr>
                </tbody>
            </table>
                    ...
                    @foreach($tenant->leaseAgreements as $leaseAgreement)
                        <tr class="border-t border-gray-300 cursor-pointer">
                            ...
                            <td class="px-4 py-2 flex items-center">
                                <ion-icon name="eye" class="mr-1 size-6 text-gray-500"></ion-icon>
                                <ion-icon name="pencil" class="mr-1 size-6 text-gray-500"></ion-icon>
                                <ion-icon name="close" class="mr-1 size-6 text-gray-500"></ion-icon>
                                <ion-icon name="trash" class="size-6 text-danger"></ion-icon>
                            </td>
                        </tr>
                    @endforeach
